...
알림 이벤트의 payload, outbox, 멱등 키, fan-out은 [NOTIFICATIONS.md](NOTIFICATIONS.md)를 따른다.
...
AI 내부 HTTP 요청·응답 스키마는 ai-service OpenAPI, 저장·검수 정책은 [AI_COPY.md](AI_COPY.md)를 따른다.
