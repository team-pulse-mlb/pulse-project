...
| 주제 | 문서 |
|---|---|
| 인증 토큰·이메일 인증 | [AUTH.md](AUTH.md) |
| 관심 선수 검색·등록 | [FAVORITE_PLAYERS.md](../policy/FAVORITE_PLAYERS.md) |
| SSE 이벤트·연결·재연결 | [SSE.md](SSE.md) |
| RabbitMQ·`ScoreTask`·outbox | [MESSAGING.md](../data/MESSAGING.md) |
| Redis 키·라이프사이클 | [REDIS_KEYS.md](../data/REDIS_KEYS.md) |
| 팀 간 Java 인터페이스 | [MODULE_INTERFACES.md](../architecture/MODULE_INTERFACES.md) |
| 경기 알림·전환 추천 | [NOTIFICATIONS.md](../policy/NOTIFICATIONS.md) |
| AI 컨텍스트·HTTP·저장·검수 | [AI_COPY.md](../policy/AI_COPY.md) |
| 데이터 저장·유실·동시성 원칙 | [DATA_STORAGE.md](../data/DATA_STORAGE.md) |
