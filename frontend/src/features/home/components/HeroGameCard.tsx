...
function HeroGameCard({ game }: { game: GameCardData }) {
  ...
  return (
    <Link
      ...
      state={{ fromCard: true }}
      className="relative flex flex-col justify-between overflow-hidden rounded-hero bg-gradient-to-br from-[#0B2559] to-[#04122E] p-7 shadow-hero transition-transform hover:-translate-y-0.5"
    >
      <div
        aria-hidden="true"
