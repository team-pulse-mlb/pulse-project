...
-- 이전 실행에서 만든 원본·대상 경기만 정리한다. 그 외 경기 데이터는 유지한다.
    ...
    IF to_regclass('public.user_notifications') IS NOT NULL THEN
        ...
        WHERE event_id IN (
            ...
            WHERE game_id BETWEEN 8800000001 AND 8800000008
               OR game_id IN (14059224001, 14059226001)
        );
    END IF;
END $$;
DELETE FROM notification_outbox WHERE game_id BETWEEN 8800000001 AND 8800000008 OR game_id IN (14059224001, 14059226001);
DELETE FROM notification_events WHERE game_id BETWEEN 8800000001 AND 8800000008 OR game_id IN (14059224001, 14059226001);
DELETE FROM game_events WHERE game_id BETWEEN 8800000001 AND 8800000008 OR game_id IN (14059224001, 14059226001);
DELETE FROM lineups WHERE game_id BETWEEN 8800000001 AND 8800000008 OR game_id IN (14059224001, 14059226001);
DELETE FROM odds_snapshots WHERE game_id BETWEEN 8800000001 AND 8800000008 OR game_id IN (14059224001, 14059226001);
DELETE FROM plays WHERE game_id BETWEEN 8800000001 AND 8800000008 OR game_id IN (14059224001, 14059226001);
DELETE FROM watch_scores WHERE game_id BETWEEN 8800000001 AND 8800000008 OR game_id IN (14059224001, 14059226001);
DO $$
BEGIN
    ...
    END IF;
END $$;
DELETE FROM games WHERE game_id BETWEEN 8800000001 AND 8800000008 OR game_id IN (14059224001, 14059226001);
