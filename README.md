...
| 설계 | [아키텍처](docs/design/architecture/ARCHITECTURE.md), [데이터 파이프라인](docs/design/data/DATA_PIPELINE.md), [API 계약 안내](docs/design/api/API_CONTRACTS.md), [SSE 계약](docs/design/api/SSE.md), [메시징 계약](docs/design/data/MESSAGING.md), [스포일러 정책](docs/design/policy/SPOILER_POLICY.md), [DB 스키마](docs/design/data/DB_SCHEMA.md) |
